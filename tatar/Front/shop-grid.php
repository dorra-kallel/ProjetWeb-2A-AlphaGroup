...
include "Controller/categorieC.php";
	...
	if(isset($_GET["id_categorie"])) {
		...
		if ((isset($_POST["recherche"]))&& (isset($_POST["colonne"]))){
			 $n=$_POST["colonne"];
			  $listearticle=(array) $articleC->rechercher($_POST["recherche"],$n);
...
<section class="u-clearfix u-section-2" id="carousel_c996">
	...
	<section class="product-area shop-sidebar shop section">
        ...
        <option value="all" >Tous</option>
          ...
          <option value="prix">Prix de produit</option>
        </select>
								...
								<div class="product-img">
									...
									<div class="button-head">
										...
										<div class="product-action-2">
											<a title="Add to cart" href="addToCart.php?id=<?php echo $product->getIdArticle(); ?>">Add to cart</a>
										</div>
									</div>
								</div>
