<?PHP
include '../tatar/Controller/campC.php';
			...
			?>
                  <div class="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                    <div class="u-container-layout u-valign-bottom-lg u-valign-bottom-xl u-valign-bottom-xs u-valign-top-md u-valign-top-sm u-container-layout-1">
                      <img class="u-expanded-width-sm u-expanded-width-xs u-image u-image-1" src="images/<?php echo $camp['image3'];?>" data-image-width="1280" data-image-height="853">
                    </div>
                  </div>
                  <div class="u-container-style u-image u-layout-cell u-left-cell u-size-30 u-image-2 " >
                    
                  <img class="u-expanded-width-sm u-expanded-width-xs u-image u-image-2" src="images/<?php echo $camp['image2'];?>" data-image-width="1280" data-image-height="853">
                  </div>
                </div>
              </div>
                ...
                <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-size-60 u-layout-cell-3">
                    <div class="u-container-layout u-container-layout-3">
                      <img class="u-expanded-width u-image u-image-3"  src="images/<?php echo $camp['image'];?>" data-image-width="150" data-image-height="100">
                      <p class="u-text u-text-1"><?PHP echo $camp['discription']; ?></p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="u-container-layout u-valign-middle-sm u-valign-middle-xs u-container-layout-4">
                      <div class="u-container-style u-group u-white u-group-1">
                        <div class="u-container-layout u-valign-middle u-container-layout-5">
                          <h3 class="u-custom-font u-font-playfair-display u-text u-text-default u-text-2"><b><?PHP echo $camp['titre']; ?></b>
                          </h3>
                          <p class="u-text u-text-3"><?PHP echo $camp['discription']; ?></p>
                        </div>
                      </div>
