      ...
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
          <table class="u-table-entity">
            ...
            <?php
            foreach($listecamp as $camp){
			      ?>  
             
            <tbody class="u-align-left u-table-alt-grey-5 u-table-body u-text-body-alt-color u-table-body-1">
              <tr style="height: 128px;">
                <td class="u-custom-font u-first-column u-font-playfair-display u-table-cell u-text-body-alt-color u-table-cell-1">Rando Pass<br><?PHP echo $camp['prixrondo']; ?>TND
                </td>
              ...
              <tr style="height: 128px;">
                <td class="u-custom-font u-first-column u-font-playfair-display u-palette-5-light-1 u-table-cell u-text-body-color u-table-cell-3">Camp pass<br><?PHP echo $camp['prixcamp']; ?>TND
                </td>
              ...
              <tr style="height: 129px;">
                <td class="u-custom-font u-first-column u-font-playfair-display u-table-cell u-text-body-alt-color u-table-cell-5">Team pass<br><?PHP echo $camp['prixgrp']; ?>TND
                </td>
            ...
            <?php echo $error; ?>
                  ...
                  <form class="forms-sample" action="" method="POST" >
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="cin" id="cin" maxlength="50" placeholder="inter your cin">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email" id="email" maxlength="250"placeholder="exemple@gmail.com">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">sexe</label>
                      <input type="text" class="form-control" name="sexe" id="sexe"placeholder="Homme/Femme">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">name</label>
                      <input type="text" class="form-control" name="name" id="name"placeholder="enter your name" value="<?php echo $_SESSION['username']; ?>" readonly >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">num</label>
                      <input type="text" class="form-control" name="num" id="num"placeholder="+216=:;;ù$^^" >
                    </div>
