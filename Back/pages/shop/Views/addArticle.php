        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="addArticle.php">Articles</a></li>
              </ul>
            </div>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="addCategorie.php">Categories</a></li>
              </ul>
            </div>
...
<!-- partial -->
        ...
        <hr> <table class="table" >
			...
			?>
					...
					<td><img src="../../../../Front/images/products/<?php if(isset($article['image'])) echo $article['image'];?>" width="200px" height="200px"> </td>
