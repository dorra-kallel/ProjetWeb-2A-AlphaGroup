 <?php
    ...
    include_once '../Controller/especeC.php';
  ...
  $bdd=new PDO('mysql:host=localhost;dbname=atelierphp', 'root', '',);
	$listeespece = $bdd->query('SELECT * FROM espece ORDER BY id');
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Table des especes</h4>
...
<td><?PHP echo $espece['f']; ?></td>
          ...
          <td>
						<a href="modifyespece.php?id=<?PHP echo $espece['id']; ?>"> Modifier </a>
					</td>
				</tr>
        ...
        <?PHP
			...
			?>
             ...
             <form method="GET">
                   ...
                   <section >
                     <?PHP
                    if($listeespece->rowCount()>0)
                     {  while($espece =$listeespece ->fetch()) {
                     ?>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter espece</h4>
                  <p class="card-description">
                    Formulaire pour ajouter une espece
                  </p>
                  <div id="error">
            <?php echo $error; ?>
        </div>
                  <form class="forms-sample" action="" method="POST" >
                    <div class="form-group">
                      <label for="exampleInputUsername1">NOM_FAMILLE</label>
                      <input type="text" class="form-control" name="nom_famille" id="nom_famille" maxlength="50" placeholder="NOM">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">nature</label>
                      <input type="text" class="form-control" name="nature" id="nature" maxlength="250">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">nourriture</label>
                      <input type="text" class="form-control" name="nourriture" id="nourriture" >
                    </div>
