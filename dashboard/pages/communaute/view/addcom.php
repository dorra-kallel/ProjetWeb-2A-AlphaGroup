    ...
    if (
      ...
      if (
      ...
      )
          {
            ...
            if( preg_match ( " /^[a-zA-Z]{2,}$/ " , $_POST['nom_com'] )==1   )
            { 
          ...
          $commC->ajoutercom($comm);
          header('Location:addcom.php');
      }
      else 
      {
        if(preg_match ( " /^[a-zA-Z]{2,}$/ " , $_POST['nom_com'] )==0){$verif_nom=1;}
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../../pages/communaute/view/addforum.php"> forum </a></li>
...
<!-- partial -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Table des communautés</h4>
        ...
        <thead>
          ...
          <td>
						...
						<input type="hidden" value=<?PHP echo $comm['id_com']; ?> name="id_com">
						</form>
					</td>
          <td>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter une communauté</h4>
            ...
            <?php echo $error; ?>
                  ...
                  <form class="forms-sample" action="" method="POST" >
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nom_com" id="nom_com" maxlength="50" placeholder="NOM">
                      <?php
                      if($verif_nom==1){
                        ?>
                        <script type="text/javascript">
            alert("le nom doit etre seulement en caractère");
          </script>
          <?php
                      $verif_titre=0;
                      }
