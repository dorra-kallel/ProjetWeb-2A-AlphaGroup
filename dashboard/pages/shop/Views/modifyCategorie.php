...
<!-- partial -->
		...
		<?php
			if (isset($_GET['id'])){
				$categorie = $categorieC->getArticleById($_GET['id']);
        
				
		?>
		<form class="form" method="post" id="form" action="UpdateAuxCategorie.php">
            <table align="center" class="table">
                <tr>
                    ...
                    <td><input type="text" name="nom" id="nom" maxlength="20" value = "<?php echo $categorie['nom']; ?>"></td>
                </tr>
