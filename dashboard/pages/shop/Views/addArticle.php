<?php
    ...
    if (isset($_POST['nom']) && isset($_POST['prix']) && isset($_POST['image'])) {
        ...
        $article->setCategorie($_POST['categories']);
        $articleC->addArticle($article);
        $filePath = "C:/Users/MSi/Downloads/".$image;
        $destinationFilePath = "C:/wamp64/www/tatar/Front/images/products/".$image;
  ...
  $listCatg = $categorieC->afficherCategorie();
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../../pages/shop/views/addarticle.php">article</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../../pages/shop/views/addcategorie.php">categorie</a></li>
...
<!-- partial -->
        ...
        <div class="main-panel" style="background-color:white ;padding-right:-15vw;">
        <div class="content-wrapper">
          <div class="row" style="background-color:white ;">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="">
                <div class="card-body">
                  <h4 class="card-title">Table des Article</h4>
        ...
        <hr> <table class="table" >
			...
			?>
					...
					<td><img src="../../../../../tatar/Front/images/products/<?php if(isset($article['image'])) echo $article['image'];?>" width="200px" height="200px"> </td>
          ...
          <td>
                    <a href="modifyArticle.php?idArticle=<?PHP if(isset($article['idArticle'])) echo $article['idArticle']; ?>"><button class="btn btn-primary">Modifier</button></a>	
					</td>
				</tr>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="" method="POST" >
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nom" id="nom" value="" maxlength="50" placeholder="NOM">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">prix</label>
                      <input type="number" class="form-control" value='' name="prix" id="prix" min=0 oninput="validity.valid||(value='');" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <option value="" disabled selected>Select your option</option>
                        <?php foreach((array)$listCatg as $cat) { ?>
  ...
  <script>
		// 4 Lines to retrieve old value of the profile
    $(document).ready(function () {
      var var1; 
      var var2;
      var var4;
        $('#nom').on('input change', function () {
            if ($(this).val() == "" ) {
		...
		$('#categories').on('input change', function () {
            if ($(this).val() == "" ) {
                $('#submit').prop('disabled', true);
