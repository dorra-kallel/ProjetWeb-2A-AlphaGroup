<?php
    ...
    if (isset($_POST['nom']) &&  isset($_POST['image'])) {
        ...
        $destinationFilePath = "C:/wamp64/www/tatar/Front/images/categories/".$image;
...
<!-- partial -->
        ...
        <hr> <table class="table" >
             ...
             <thead>
                      ...
                      <?PHP
                      if(!empty($listCatg)) {
				foreach((array)$listCatg as $catg){
			?>
							<tr>
					 <td><?PHP if(isset($catg['id'])) echo $catg['id']; ?></td>
					<td><?PHP if(isset($catg['nom'])) echo $catg['nom']; ?></td>
				
					
					
					<td><img src="../../../../../tatar/Front/images/categories/<?php if(isset($catg['image'])) echo $catg['image'];?>" width="200px" height="200px"> </td>
					...
					<td>
						...
						<input type="hidden" value=<?PHP if(isset($catg['id'])) echo  $catg['id']; ?> name="id">
						</form>
					</td>
          <td>
                    <a href="modifyCategorie.php?id=<?PHP if(isset($catg['id'])) echo $catg['id']; ?>"><button class="btn btn-primary">Modifier</button></a>	
					</td>
				</tr>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="" method="POST" >
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nom" id="nom" maxlength="50" placeholder="NOM">
                    </div>
                    <div class="form-group">
